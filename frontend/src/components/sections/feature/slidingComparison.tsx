...
type SlidingComparisonProps = Pick<FeatureSection, 'badgeText' | 'heading' | 'subheading' | 'image' | 'comparisonImage'>;

export default function SlidingComparison({
  badgeText,
  heading,
  subheading,
  image,
  comparisonImage
}: SlidingComparisonProps) {
